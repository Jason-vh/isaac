...
type SortKey = "name" | "medianDuration" | "delta" | "p50Queue" | "cpContrib" | "retryRate" | "retryDelta";
...
const gridClass = computed(() =>
  props.criticalPath
    ? "grid-cols-[1fr_5rem_7rem_5rem_1px_5rem_5rem_5rem]"
    : "grid-cols-[1fr_5rem_7rem_5rem_1px_5rem_5rem]"
);
